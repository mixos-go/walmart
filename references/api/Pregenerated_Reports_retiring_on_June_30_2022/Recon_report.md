...
**Method:** GET
**HTTP Path:** https://marketplace.walmartapis.com/v3/report/reconreport/reconFile?reportVersion=v1
...
| reportVersion (query) | string | Yes | Report Version |
