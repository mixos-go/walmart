---
title: Taxonomy_by_spec
category: Utilities_Management
api_name: Taxonomy_by_spec
method: GET
path: /v3/utilities/taxonomy
---

**Category:** Utilities_Management
**API:** Taxonomy_by_spec

**Method:** GET
**HTTP Path:** https://marketplace.walmartapis.com/v3/utilities/taxonomy
...
| --- | --- | --- | --- |
| feedType (query) | string | No | Specifies the Feed Type |
| version (query) | string | No | Specifies the version for the Feed Type |
