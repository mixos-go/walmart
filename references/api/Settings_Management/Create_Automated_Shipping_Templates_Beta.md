---
title: Create_Automated_Shipping_Templates_Beta
category: Settings_Management
api_name: Create_Automated_Shipping_Templates_Beta
method: POST
path: /v3/settings/shipping/templates/automatedShippingTemplate
---

**Category:** Settings_Management
**API:** Create_Automated_Shipping_Templates_Beta

**Method:** POST
**HTTP Path:** https://marketplace.walmartapis.com/v3/settings/shipping/templates/automatedShippingTemplate

## API Description
Create Automated Shipping Templates (Beta)
...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| fulfillmentCenterName | string | No | Fulfillment Center Name |
| fulfillmentCenterZipCode | string | No | Fulfillment Center Zipcode |
| carrierMethodName | string | No | Carrier Method Name. Supported carrier methods are: FEDEX_GROUND |
