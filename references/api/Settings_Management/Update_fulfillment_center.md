---
title: Update_fulfillment_center
category: Settings_Management
api_name: Update_fulfillment_center
method: PUT
path: /v3/settings/shipping/shipnodes
---

**Category:** Settings_Management
**API:** Update_fulfillment_center
...
| shipNode | object | No |  |
| shipNode.shipNode | string | No | The fulfillment center or ship node Id which uniquely identifies each facility and is autogenerated during the creation of fulfillment center. Every time a facility is added, a new ship node id is generated. |
...
| shipNode.calendarDayConfiguration.carrierWeekendCalendar | object | No | Operating Schedule for the carrier |
| shipNode.calendarDayConfiguration.carrierWeekendCalendar.sunday | object | No |  |
| shipNode.calendarDayConfiguration.carrierWeekendCalendar.sunday.workingDay | boolean | No | Flag to specify if carrier is operational on the specified day of each week. Allowed values are true or false. |
| shipNode.calendarDayConfiguration.carrierWeekendCalendar.saturday | object | No |  |
| shipNode.calendarDayConfiguration.carrierWeekendCalendar.saturday.workingDay | boolean | No | Flag to specify if carrier is operational on the specified day of each week. Allowed values are true or false. |
