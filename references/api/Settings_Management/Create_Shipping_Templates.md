---
title: Create_Shipping_Templates
category: Settings_Management
api_name: Create_Shipping_Templates
method: POST
path: /v3/settings/shipping/templates
---

**Category:** Settings_Management
**API:** Create_Shipping_Templates
...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| name | string | No | Shipping Template Name |
| type | string | No | Shipping Template Type, should be CUSTOM or 3PL Specific |
| rateModelType | string | No | This is the shipping model type. TIERED_PRICING: This model means that you charge shipping based on the price of the item PER_SHIPMENT_PRICING: This model means that you charge shipping based on the weight of your items (per pound), or you charge shipping based on the number of items purchased in an |
| status | string | No | Shipping Template Status, Can be ACTIVE or INACTIVE status |
| shippingMethods | array<object> | No | Array of different ship methods of a Shipping Template |
