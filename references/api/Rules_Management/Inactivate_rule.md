---
title: Inactivate_rule
category: Rules_Management
api_name: Inactivate_rule
method: PUT
...
**Method:** PUT
**HTTP Path:** https://marketplace.walmartapis.com/v3/rules/inactivate
...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| message | string | No | Message and status of inactivation of rule |
