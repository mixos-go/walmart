---
title: Acknowledge_Orders
category: Order_Management
api_name: Acknowledge_Orders
method: POST
path: /v3/orders/{purchaseOrderId}/acknowledge
---

**Category:** Order_Management
**API:** Acknowledge_Orders

**Method:** POST
**HTTP Path:** https://marketplace.walmartapis.com/v3/orders/{purchaseOrderId}/acknowledge
