---
title: Refund_Order_Lines
category: Order_Management
api_name: Refund_Order_Lines
method: POST
path: /v3/orders/{purchaseOrderId}/refund
---

**Category:** Order_Management
**API:** Refund_Order_Lines

**Method:** POST
**HTTP Path:** https://marketplace.walmartapis.com/v3/orders/{purchaseOrderId}/refund
...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| orderRefund | object | No |  |
| orderRefund.purchaseOrderId | string | No |  |
| orderRefund.orderLines | object | No |  |
| orderRefund.orderLines.orderLine | array<object> | No |  |
| orderRefund.orderLines.orderLine.lineNumber | string | No |  |
| orderRefund.orderLines.orderLine.isFullRefund | boolean | No | Specifies that a full Refund is required to be set as true to do a full refund including all the applicable charges like tax and shipping. If full refund is set as false and full item price is entered in the charge amount field, applicable charges like tax and shipping will also be refunded to perfo |
| orderRefund.orderLines.orderLine.refunds | object | No |  |
| orderRefund.orderLines.orderLine.refunds.refund | array<object> | No |  |
| orderRefund.orderLines.orderLine.refunds.refund.refundId | string | No |  |
| orderRefund.orderLines.orderLine.refunds.refund.refundComments | string | No |  |
| orderRefund.orderLines.orderLine.refunds.refund.refundCharges | object | No |  |
| orderRefund.orderLines.orderLine.refunds.refund.refundCharges.refundCharge | array<object> | No |  |
...
| orderRefund.orderLines.orderLine.refunds.refund.refundCharges.refundCharge.charge | object | No | List of elements that make up a charge |
| orderRefund.orderLines.orderLine.refunds.refund.refundCharges.refundCharge.charge.chargeType | string | No | The charge type for line items can be one of the following: PRODUCT or SHIPPING For details, refer to 'Charge Types' |
| orderRefund.orderLines.orderLine.refunds.refund.refundCharges.refundCharge.charge.chargeName | string | No | If chargeType is PRODUCT, chargeName is Item Price. If chargeType is SHIPPING, chargeName is Shipping |
| orderRefund.orderLines.orderLine.refunds.refund.refundCharges.refundCharge.charge.chargeAmount | object | No | The details for the amount of the tax charge |
...
| orderRefund.orderLines.orderLine.refunds.refund.refundCharges.refundCharge.charge.chargeAmount.amount | number | No | The numerical amount for that charge. Example: 9.99 |
| orderRefund.orderLines.orderLine.refunds.refund.refundCharges.refundCharge.charge.tax | object | No | Tax information for the charge, including taxName and taxAmount |
| orderRefund.orderLines.orderLine.refunds.refund.refundCharges.refundCharge.charge.tax.taxName | string | No | The name associated with the tax. Example: 'Sales Tax' |
| orderRefund.orderLines.orderLine.refunds.refund.refundCharges.refundCharge.charge.tax.taxAmount | object | No | The details for the amount of the tax charge |
...
| orderRefund.orderLines.orderLine.refunds.refund.refundCharges.refundCharge.charge.tax.taxAmount.amount | number | No | The numerical amount for that charge. Example: 9.99 |
