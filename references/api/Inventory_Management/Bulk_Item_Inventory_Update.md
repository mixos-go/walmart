---
title: Bulk_Item_Inventory_Update
category: Inventory_Management
api_name: Bulk_Item_Inventory_Update
method: POST
path: /v3/feeds
---

**Category:** Inventory_Management
**API:** Bulk_Item_Inventory_Update
...
| shipNode (query) | string | No | The shipNode for which the inventory is to be updated. Not required in case of Multi Node Inventory Update Feed (feedType=MP_INVENTORY) |
