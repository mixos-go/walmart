...
**Method:** GET
**HTTP Path:** https://marketplace.walmartapis.com/v3/lagtime
...
| fulfillmentLagTime | integer | Yes | The number of days between when the item is ordered and when it is shipped |
