---
title: Confirm_Carrier_Rate_Quote
category: Fulfillment_Management
api_name: Confirm_Carrier_Rate_Quote
method: POST
path: /v3/fulfillment/carrier-rate-quote/confirm
---

**Category:** Fulfillment_Management
**API:** Confirm_Carrier_Rate_Quote

**Method:** POST
**HTTP Path:** https://marketplace.walmartapis.com/v3/fulfillment/carrier-rate-quote/confirm
